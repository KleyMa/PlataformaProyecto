<x-layouts.app title="Log Usuarios" meta-description="Pagina de visualizacion de logs"> <!-- Para las etiquetas se usa kebab-case y para componentes camelCase, Laravel lo interpreta solo-->
    <div class="container">
        <h1>Logs de usuarios</h1>
    </div>
    <div class="container">
        <div class="row">
        ...
        <table class="table table-bordered table-striped mt-3">
            <thead class="thead-dark">
              <tr>
                ...
                <th class="col-1 text-center">ID Usuario Editado</th>
                <th class="col-1 text-center">Usuario Editado</th>
                <th class="col-1 text-center">Fecha</th>
                <th class="col-1 text-center">Accion</th>
              </tr>
            </thead>
            <tbody>
            @foreach ($usuariosLogs as $usuariosLog)
              <tr>
                <td class="text-center">{{$usuariosLog->id}}</td>
                <td class="text-center">{{$usuariosLog->id_usuario}}</td>
                <td class="text-center">{{$usuariosLog->usuario}}</td>
                <td class="text-center">{{$usuariosLog->id_usuario_editado}}</td>
                <td class="text-center">{{$usuariosLog->usuario_editado}}</td>
                <td class="text-center">{{$usuariosLog->fecha}}</td>
                <td class="text-center">{{$usuariosLog->accion}}</td>
              </tr>
            @endforeach
            </tbody>
        </table>     
